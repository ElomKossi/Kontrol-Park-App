...
namespace APP.Areas.Garage.Controllers
{
    public class TypeInterventionController : Controller
    {
        ...
        [HttpPost]
        public ActionResult Ajouter(TypeIntervention typeI)
        {
            TypeIntervention ti = new TypeIntervention
            {
                LibelleTypeIntervention = typeI.LibelleTypeIntervention,
                Supprimer = false,
            };
            db.TypeIntervention.Add(ti);
            ...
            nvelActions.LibelleAction = "Ajout de " + ti.LibelleTypeIntervention;
        ...
        [HttpPost]
        public ActionResult Editer(TypeIntervention tmp1)
        {
            if (ModelState.IsValid)
            {
                ...
                nvelActions.HeureAction = DateTime.UtcNow;
                nvelActions.IdConnexion = t.IdConnexion;
                nvelActions.LibelleAction = "Modification de " + tmp1.LibelleTypeIntervention;
                db.Action.Add(nvelActions);
        ...
        {
            TypeIntervention typeC = db.TypeIntervention.Find(id);
            ...
            if (typeC.Supprimer == true)
            {
                ...
                nvelActions.HeureAction = DateTime.UtcNow;
                nvelActions.IdConnexion = t.IdConnexion;
                nvelActions.LibelleAction = "Restauration du " + typeC.LibelleTypeIntervention;
                db.Action.Add(nvelActions);
            }
            else
            {
                ...
                nvelActions.HeureAction = DateTime.UtcNow;
                nvelActions.IdConnexion = t.IdConnexion;
                nvelActions.LibelleAction = "Suppression du " + typeC.LibelleTypeIntervention;
                db.Action.Add(nvelActions);
            }
